...
It exposes an API for Capella and a Next.js UI (web-alt) for browsing/verifying receipts.
...
- Provide a Next.js UI (web-alt) for browsing and verifying receipts.
...
* UI (web-alt) fetches and verifies.
