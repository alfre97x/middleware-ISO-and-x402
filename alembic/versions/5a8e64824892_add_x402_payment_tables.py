...
Revision ID: 5a8e64824892
Revises: 8d23500035d7
Create Date: 2026-01-20 14:02:06.275326
...
def upgrade() -> None:
    # Create new x402 tables
    op.create_table('protected_endpoints',
    ...
    sa.Column('agent_id', sa.CHAR(36), nullable=True),
